...
<iframe sandbox="allow-same-origin allow-forms allow-top-navigation allow-scripts allow-popups" frameborder="0" width="100%"  style="min-height: 600px" id="payever_iframe" src="[{$oView->getIframePaymentUrl()}]"></iframe>
